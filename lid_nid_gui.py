...
class LidNidMapperGUI:
    def __init__(self, master, *args, **kwargs):
        ...
        self.audience_menu_window.grid(row=2, column=1, sticky=W+E)
        ...
        self.campaign_id_entry.grid(row=3, column=1, sticky=W+E)
        ...
        self.submit_btn.grid(row=4, column=0, columnspan=2,  padx=10, pady=5, sticky=N+S+E+W)
        self.query_btn = Button(master, text="Run Query", width=10, command=lambda: run_query(function) )
        self.query_btn.grid(row=5, column=0, columnspan=2, padx=10, pady=5, sticky=N+S+E+W)
